...
public class FlashControlCaseOnWithPreview extends FlashControl {
    public static final String flash_control_type = "FLASH_CONTROL_ON_PREVIEW";
    private Camera camera;
    private Timer flashOnTimer;
    private boolean isFlashTurnedOn;
    private Parameters parameters;

    public FlashControlCaseOnWithPreview() {
        this.camera = null;
    ...
    public void FlashOnDuration(int updateFreq) {
        ...
        this.flashOnTimer.schedule(new TimerTask() {
            public void run() {
                FlashControlCaseOnWithPreview.this.FlashOff();
            }
        }, (long) updateFreq);
    }
